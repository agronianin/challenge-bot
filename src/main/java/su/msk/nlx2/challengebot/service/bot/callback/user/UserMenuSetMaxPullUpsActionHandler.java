...
public class UserMenuSetMaxPullUpsActionHandler extends UserMenuActionHandler {
    private final PrivateChatUpdateHandler privateChatUpdateHandler;

    @Override
    public String callbackData() {
        return UserKeyboardFactory.USER_MENU_SET_MAX_PULL_UPS_CALLBACK;
    }

    @Override
    public void handle(UserMenuActionContext context) {
        privateChatUpdateHandler.startSetMaxPullUps(context.privateChatId(), context.user());
    }
}
